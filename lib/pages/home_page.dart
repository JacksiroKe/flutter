...
class HomePageState extends State<HomePage> {
  ...
  User user;
  TextEditingController oldPasswordController = new TextEditingController(text: "");
  TextEditingController newPasswordController = new TextEditingController(text: "");
  ...
  static ProgressDialog progressDialog = ProgressDialog.getProgressDialog(ProgressDialogTitles.USER_CHANGE_PASSWORD);
          ...
          children: <Widget>[
            new Container(
              child: new Text(
                ...
                style: new TextStyle(color: Colors.blue, fontSize: 26.0),
              ),
